          ...
          { /* eslint-disable-next-line react/no-unescaped-entities */ }
            ...
            <section className="flex bg-gray-200">
               ...
               <div className="flex mx-5">
                  <div><Image width={100} height={300} src="/KD1.jpg" alt="main"/>
                       <Image width={100} height={300} src="/KD1.jpg" alt="main"/>
                       <Image width={100} height={300} src="/KD1.jpg" alt="main"/>
                    </div>
                    <div className="ml-2">
                        <Image width={300} height={300} src="/KD1.jpg" alt="main"/>
                    </div>
                </div>
                {/* right side */}
                ...
                <div>
                    <h1 className="font-bold text-5xl ml-[150px]">Khadar 3pcs Suit</h1> 
                    <div className="flex items-center ml-[150px] mt-3">
                     ...
                     <p className="mb-4">The Khadar Perfect For Winter ANd too Comfortable to Wear Witn Reasonable Prize, Quality and Colors. <br />
                     So Dont Wait  Buy Now  .</p>
                     <span className="line-through font-bold text-2xl mt-3">Pkr 3750 </span> 
                     <span className="ml-2 text-3xl font-extrabold">Pkr 3550 </span>
                     <div className="text-center" ><button className="bg-slate-300 border border-gray-900 w-[100px] rounded-lg mt-10 mr-[90%] ">BUY NOW</button></div>
            ...
            <section>
            <h2 className="font-bold text-3xl text-center mt-8">MORE DESIGNS</h2>
